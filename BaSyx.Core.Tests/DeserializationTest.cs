...
namespace BaSyx.Core.Tests
{
    ...
    public class DeserializationTest
    {
        ...
        [TestMethod]
        public void TestMethod2_SerializeAndDeserializeInvocationRequest()
        {
            ...
            string serializedInvocationRequest = JsonConvert.SerializeObject(request, jsonSerializerSettings);
            InvocationRequest deserializedInvocationRequest = JsonConvert.DeserializeObject<InvocationRequest>(serializedInvocationRequest, jsonSerializerSettings);
            //deserializedInvocationRequest.Should().BeEquivalentTo(request);
        }
    }
}
