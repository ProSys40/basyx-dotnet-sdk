...
{
    public abstract class AssetAdministrationShellRegistryTestSuite
    {
        protected abstract IAssetAdministrationShellRegistry GetAssetAdministrationShellRegistry();
